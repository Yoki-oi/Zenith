...
function ch(title: string, desc = '', chemSection?: any): Chapter {
  return { id: uid(), title, desc, doing: false, mastered: false, revisions: 0, items: [], chemSection: chemSection || null, open: false };
}

export const PALETTE = ['#e8673c','#38bdf8','#86efac','#fbbf24','#c084fc','#f472b6','#34d399','#60a5fa','#fb923c','#a3e635'];
...
export const CHEM_SHORT  = { Physical: 'PC', Organic: 'OC', Inorganic: 'IOC' };

export function buildSeedData(): Subject[] {
  return [
    // ── Class 11 Maths ─────────────────────────────
    {
      id: uid(), name: 'Mathematics', icon: '∑', color: '#a3e635', classNum: 11, type: 'normal',
      chapters: [
        ...
        ch('Conic Sections', 'Circle, parabola, ellipse, hyperbola — standard forms'),
        ch('Introduction to 3D Geometry', 'Axes, planes, distance formula'),
        ch('Limits & Derivatives', 'L\'Hôpital, sandwich theorem, first principle'),
    ...
    // ── Class 11 Physics ────────────────────────────
    {
      id: uid(), name: 'Physics', icon: '⚡', color: '#38bdf8', classNum: 11, type: 'normal',
      chapters: [
    ...
    // ── Class 11 Chemistry ──────────────────────────
    {
      id: uid(), name: 'Chemistry', icon: '⚗', color: '#c084fc', classNum: 11, type: 'chemistry',
      chapters: [
        ...
        ch('Hydrocarbons', 'Alkanes, alkenes, alkynes, arenes — reactions', 'Organic'),
    ...
    // ── Class 12 Maths ─────────────────────────────
    {
      id: uid(), name: 'Mathematics', icon: '∑', color: '#a3e635', classNum: 12, type: 'normal',
      chapters: [
    ...
    // ── Class 12 Physics ────────────────────────────
    {
      id: uid(), name: 'Physics', icon: '⚡', color: '#38bdf8', classNum: 12, type: 'normal',
      chapters: [
    ...
    // ── Class 12 Chemistry ──────────────────────────
    {
      id: uid(), name: 'Chemistry', icon: '⚗', color: '#c084fc', classNum: 12, type: 'chemistry',
      chapters: [
        ...
        ch('p-Block Elements (15–18)', 'N, P, O, S, halogens, noble gases — oxoacids & halides', 'Inorganic'),
