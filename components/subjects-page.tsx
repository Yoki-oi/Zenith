  ...
  return (
    <div className="min-h-screen bg-[#0a0d14] relative">
      ...
      <main className="relative pt-20 px-4 sm:px-6 xl:px-10 flex flex-col min-h-screen">
        ...
        <footer className="px-4 sm:px-6 xl:px-10 mt-auto pt-6 pb-[env(safe-area-inset-bottom,24px)] border-t border-white/[0.04] flex flex-col sm:flex-row items-center sm:justify-between gap-1 text-sm text-gray-700 text-center sm:text-left">
