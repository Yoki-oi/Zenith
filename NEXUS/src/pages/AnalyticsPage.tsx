    ...
    <div className="rounded-xl p-6 relative overflow-hidden"
      ...
      <div className="flex items-center gap-6">
        <div className="relative shrink-0">
          <Ring pct={st.pct} color={color} size={92} />
          <div className="absolute inset-0 flex items-center justify-center">
            <span className="text-base font-bold mono" style={{ color }}>{st.pct}%</span>
          </div>
        </div>
        <div className="flex-1">
          <p className="font-semibold text-base mb-0.5" style={{ color:'var(--t1)' }}>Class {cls}</p>
          <p className="text-xs mono mb-4" style={{ color:'var(--t3)' }}>{st.total} chapters total</p>
  ...
  return (
    <div className="h-full overflow-y-auto page-enter" style={{ background:'transparent' }}>
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold tracking-tight mb-1.5" style={{ fontFamily:'Space Grotesk', letterSpacing:'-1px', color:'var(--t1)' }}>
            Analytics
          </h1>
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-xs mono" style={{ color:'var(--t3)' }}>click any subject to open tracker</span>
          </div>
